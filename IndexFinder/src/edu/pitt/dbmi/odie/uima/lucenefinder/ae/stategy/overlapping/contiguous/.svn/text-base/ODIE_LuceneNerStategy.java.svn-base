package edu.pitt.dbmi.odie.uima.lucenefinder.ae.stategy.overlapping.contiguous;
				...
				if (isAlphaNonStopword(annotation.getCname())) {
				    ...
				    if(results.totalHits>0){
				        ...
				        for (ScoreDoc hit : hits) {
				        	...
				        	ODIE_LuceneNerCandidate candidateTally = new edu.pitt.dbmi.odie.uima.lucenefinder.ae.stategy.overlapping.contiguous.ODIE_LuceneNerCandidate() ;
