 ...
 * </ul>
 */
public class ODIE_XmiWriterCasConsumer extends CasConsumer_ImplBase {
	/**
	...
	public void processCas(CAS aCAS) throws ResourceProcessException {
		...
		if (it.hasNext()) {
			SourceDocumentInformation fileLoc = (SourceDocumentInformation) it
					.next();
			String fileUri = fileLoc.getUri();
			String outFileName = fileUri + ".xmi";
			outFile = new File(mOutputDir, outFileName);
			modelFileName = mOutputDir.getAbsolutePath() + "/" + fileUri
					+ ".ecore";
		}
		if (outFile == null) {
	 ...
	 * @throws ResourceProcessException
	 */
	private void writeXmi(CAS aCas, File outputFile)
