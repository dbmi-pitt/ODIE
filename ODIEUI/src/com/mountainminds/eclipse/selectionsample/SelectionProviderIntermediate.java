...
public class SelectionProviderIntermediate implements IPostSelectionProvider {
	...
	protected final ListenerList selectionListeners = new ListenerList();

	protected final ListenerList postSelectionListeners = new ListenerList();

	protected ISelectionProvider delegate;
