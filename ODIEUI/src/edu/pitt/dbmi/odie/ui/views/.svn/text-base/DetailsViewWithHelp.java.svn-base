...
public class DetailsViewWithHelp extends DetailsView {

	private final String DEFAULT_HELP_TEXT = "The Details View shows additional information about the selected "
			+ "concept, suggestion or annotation in the corresponding views.";
