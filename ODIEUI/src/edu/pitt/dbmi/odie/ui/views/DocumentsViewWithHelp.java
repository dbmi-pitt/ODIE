...
public class DocumentsViewWithHelp extends DocumentsView {

	private final String DEFAULT_HELP_TEXT = "The Documents View shows the documents that were "
			+ "analyzed by the current analysis. \n\n"
			+ "This view is filtered based on selections in the Concepts "
			+ "View\n\n"
			+ "You can double-click on a document to view its contents "
			+ "and annotations.";
