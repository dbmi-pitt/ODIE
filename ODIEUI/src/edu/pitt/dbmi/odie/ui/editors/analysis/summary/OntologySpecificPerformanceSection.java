...
public class OntologySpecificPerformanceSection extends SectionPart {
	private static final String DESCRIPTION = "";

	Logger logger = Logger.getLogger(this.getClass());
	private OntologyPerformanceTreeTable performanceTreeTable;
	...
	public OntologySpecificPerformanceSection(FormEditor editor, Composite parent, int style) {
	...
	public void initialize(final IManagedForm form) {
		...
		section.setText("Ontology Specific Performance");
		...
		performanceTreeTable = new OntologyPerformanceTreeTable(sectionClient);
		gd = new GridData();
