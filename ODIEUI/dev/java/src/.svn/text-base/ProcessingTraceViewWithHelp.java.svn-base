...
public class ProcessingTraceViewWithHelp extends ProcessingTraceView{

	private final String DEFAULT_HELP_TEXT = "The Processing Trace View displays the processing history for the current annotation";
