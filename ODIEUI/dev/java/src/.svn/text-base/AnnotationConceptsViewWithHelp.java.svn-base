...
public class AnnotationConceptsViewWithHelp extends AnnotationConceptsView{

	private final String DEFAULT_HELP_TEXT = "The Annotation Concepts View displays the processing history for the current annotation";
